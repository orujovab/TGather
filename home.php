...
<?php include 'header.php';?>
    <div class="container">
        ...
        $sql = "SELECT posts.post_caption, posts.post_time, posts.post_public, user_form.name,
                        user_form.username, user_form.id, user_form.user_type, posts.post_id
                FROM posts
                JOIN user_form
                ON posts.post_by = user_form.id
                WHERE posts.post_public = 'Y' OR user_form.id = {$_SESSION['user_id']}
                UNION
                SELECT posts.post_caption, posts.post_time, posts.post_public, user_form.name,
                        user_form.username, user_form.id, user_form.user_type, posts.post_id
                FROM posts
                JOIN user_form
                ON posts.post_by = user_form.id
